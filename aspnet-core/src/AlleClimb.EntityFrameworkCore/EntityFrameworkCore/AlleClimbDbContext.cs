...
public class AlleClimbDbContext :
    AbpDbContext<AlleClimbDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AlleClimbDbContext(DbContextOptions<AlleClimbDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AlleClimbConsts.DbTablePrefix + "YourEntities", AlleClimbConsts.DbSchema);
